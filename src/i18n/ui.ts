...
export const ui: Record<Locale, UIStrings> = {
  en: {
    ...
    navHint: "Hover any card to loop its animation — or click inside a demo to interact with it.",
  ...
  "zh-tw": {
    ...
    navHint: "將游標移到任一卡片即可循環播放動畫，或點擊示範內容直接互動。",
  ...
  ja: {
    ...
    navHint: "カードにカーソルを合わせるとアニメーションがループ再生されます。デモ内をクリックすると操作できます。",
  ...
  ko: {
    ...
    navHint: "카드에 마우스를 올리면 애니메이션이 반복 재생되고, 데모를 클릭하면 직접 조작할 수 있습니다.",
  ...
  "pt-br": {
    ...
    navHint: "Passe o cursor sobre qualquer cartão para repetir a animação — ou clique dentro de uma demonstração para interagir.",
  ...
  es: {
    ...
    navHint: "Pasa el cursor sobre cualquier tarjeta para reproducir su animación en bucle, o haz clic dentro de una demo para interactuar.",
  ...
  fr: {
    ...
    navHint: "Survolez une carte pour lire son animation en boucle, ou cliquez dans une démo pour interagir.",
  ...
  de: {
    ...
    navHint: "Bewege den Mauszeiger über eine Karte, um die Animation zu wiederholen – oder klicke in eine Demo, um damit zu interagieren.",
